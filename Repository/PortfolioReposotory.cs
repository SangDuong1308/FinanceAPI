...
{
    public class PortfolioReposotory : IPortfolioRepository
    {
        private readonly ApplicationDBContext _context;
        public PortfolioReposotory(ApplicationDBContext context)
        {
            _context = context;
        }
        ...
        public async Task<Portfolio> DeletePortfoilio(AppUser appUser, string symbol)
        {
